...
const Login = () => {
  return (
    <>
      <div className="grid place-items-center h-full m-0 px-[24px] bg-login bg-no-repeat bg-cover animate-background-pan">
        <div className="w-[400px] h-full px-[30px] pt-[70px] pb-[44px] round-[24px] bg-white text-center">
